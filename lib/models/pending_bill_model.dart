...
PendingBillsModel pendingBillsModelFromJson(String str) =>
    PendingBillsModel.fromJson(json.decode(str));

String pendingBillsModelToJson(PendingBillsModel data) =>
...
class PendingBillsModel {
  ...
  factory PendingBillsModel.fromJson(Map<String, dynamic> json) =>
      PendingBillsModel(
...
class PendingBillRequestModel {
  ...
  PendingBillRequestModel(
      {required this.schema, required this.bpNumber, required this.payNow});
