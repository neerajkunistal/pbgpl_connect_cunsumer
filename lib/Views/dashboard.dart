...
class BillAmountDashboard extends StatefulWidget {
  @override
  _BillAmountDashboardPageState createState() =>
      _BillAmountDashboardPageState();
}
...
class _BillAmountDashboardPageState extends State<BillAmountDashboard> {
  ...
  Future fetchPendingBill() async {
    ...
    var response =
        await apiIntegration!.apiPengingBill(pendingBillRequestModel!);
    if( response != null){
                ...
                child: Stack(
                  children: [
                    KenBurns(
                      maxScale: 5,
                      child: Image.asset(
                        "assets/images/backgroundbill.jpg",
                        fit: BoxFit.cover,
                      ),
                    ),
                  ],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              amount.isEmpty ? "No Amount" : "$amount INR",
                              style: amountUser,
                            ),
                          ],
                        ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Text("BP Number",
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: cardUserDetails),
                                                ),
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.all(8.0),
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text('PNG SERVICES CHARGE',
  ...
  launchURL() async {
    if(pdf.isNotEmpty){
      if (!await launchUrl(Uri.parse(pdf))) {
