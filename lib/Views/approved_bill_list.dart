                    ...
                    onSelectChanged: (b) {
                      ...
                      onSelectedRow(b, user);
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    Text(user.billNo!.toString() == null
                                        ? '-'
                                        : user.billNo!.toString() == null
                                            ? '-'
                                            : user.billNo.toString()),
                                  ),
                                  DataCell(
                                    Text(user.crn!.toString() == null
                                        ? '-'
                                        : user.crn!.toString() == null
                                            ? '-'
                                            : user.crn!.toString()),
                                  ),
                                  DataCell(
                                    Text(user.bpNumber!.toString() == null
                                        ? '-'
                                        : user.bpNumber!.toString() == null
                                            ? '-'
                                            : user.bpNumber!.toString()),
                                  ),
                                  DataCell(
                                    Text(user.billGeneratedDate!.toString() ==
                                            null
                                        ? '-'
                                        : user.billGeneratedDate!.toString() ==
                                                null
                                            ? '-'
                                  ...
                                  DataCell(
                                    Text(user.oldReading!.toString() == null
                                        ? '-'
                                        : user.oldReading!.toString() == null
                                            ? '-'
                                            : user.oldReading!.toString()),
                                  ),
                                  DataCell(
                                    Text(user.currentBillReading!.toString() ==
                                            null
                                        ? '-'
                                        : user.currentBillReading == null
                                            ? '-'
                                            : user.currentBillReading!
                                                .toString()),
                                  ),
                                  DataCell(
                                  ...
                                  DataCell(
                                    Text(user.rejectReason!.toString() == null
                                        ? '-'
