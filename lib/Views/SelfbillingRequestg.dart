...
class SelfBillingReques extends StatefulWidget {
  ...
  SelfBillingReques({Key? key,
    required this.scm,
    required this.amount,
    required this.old,
    required this.currency}) : super(key: key);
  @override
...
class MeterReadingNumberState extends State<SelfBillingReques> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text( "Customer Self Billing",style: selfBilling,),
                          ...
                          child: FocusScope(
                            ...
                            child: TextField(
                                ...
                                onChanged: (text) {
                                  ...
                                  myController9.text = userSearchItems[userSearchItems.length-2];
                                  myController8.text = userSearchItems[userSearchItems.length-3];
                                  myController7.text = userSearchItems[userSearchItems.length-4];
                                  myController6.text = userSearchItems[userSearchItems.length-5];
                                  myController5.text = userSearchItems[userSearchItems.length-6];
                                  myController4.text = userSearchItems[userSearchItems.length-7];
                                  myController3.text = userSearchItems[userSearchItems.length-8];
                                }),
                          ),
                          decoration: BoxDecoration(
                            border: Border.all(color: Colors.deepPurpleAccent),
                ...
                InkWell(
                  ...
                  onTap: () {
                    ...
                    if ((myController10.text.isEmpty ?? true)) {
                      showErrorMessage("Current Meter reading is required", context);
                    } else{
                      showBottomSheet(
                        context: context,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: new TextButton(
                                                          child: new Text("TAKE PHOTO",style: TextStyle(color: Colors.white)),
                                                          onPressed: () async {
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Align(
                                                        ...
                                                        child: Text("$checkStatus",style: TextStyle(color: Colors.green),)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: CustomTextEmailField(
                                                    ...
                                                    filledColor: Colors.lightBlueAccent.shade100.withOpacity(.1),
                                                  )),
                                            ),
                                            GestureDetector(
                                              onTap: (){
                                                var i1;
                                                if (meterPhotoContrller != null && meterPhotoContrller.imagePath != null) {
                                                  i1 = meterPhotoContrller.imagePath!.path;
                                                  btnClick(context, i1,current);
                                                } else {
                                                  showErrorMessage("Please upload meter image ", context);
                                                }
                                              },
                                              child: Padding(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('Submit',textAlign: TextAlign.left,style: submit,),
                                                    ),
                                                  ),
                                                ),
                                              ),
                                              ...
                                              child: Padding(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text('CLOSE', textAlign: TextAlign.left,style: submit),
                                                    ),
                                                  ),
                                                ),
                                              ),
  ...
  Future<void> getLocal() async {
    ...
    setState(() {
      meterSerialNumber.text=pref!.getString(GlobalConstants.meterSerialNumber).toString();
    });
  }

  selfBillingRequest(BuildContext context, String current, String totalReading,double totalAmount) {
    AlertDialog alert = AlertDialog(
      title: Column(
        ...
        children: [
          Card(
            ...
            child:Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(child: Text("CURRENT BILL DETAILS",style: TextStyle(fontSize: 18),)),
            ),
          ),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Current Meter  Reading ",style: TextStyle(fontSize: 18),),
                    ...
                    Text("Old Meter Reading",style: TextStyle(fontSize: 18),),
                    ...
                    Text(
                      "Total Meter Reading",style: TextStyle(fontSize: 18),),
                    CardText(
                        text:
                        "${totalReading}"),
                    new SizedBox(
                    ...
                    Text(
                      "Per SCM Amount ",style: TextStyle(fontSize: 18),),
                    CardText(
                        text:
                        "${widget.scm}"),
                    new SizedBox(
                    ...
                    Text(
                      "Total Bill Amount",style: TextStyle(fontSize: 18),),
                    CardText(
                        text:
                        "${(widget.scm)}*$totalReading =  $totalAmount"),
            ...
            TextButton(
              ...
              onPressed: () async {
                if(totalAmount>=100000) {
                  EasyLoading.showInfo("Total Bill Amount should be less than 1 lacs");
                }  else {
                  Navigator.of(context).pop();
                  ...
                  PayBillResponse lgd = new PayBillResponse.fromJson(json.decode(jwt));
                  EasyLoading.dismiss();
      ...
      if (pickedFile != null) {
        ...
        if (meterPhotoContrller != null &&
          ...
          setState(() {
            ...
            fileName1.text = meterPhotoContrller.imagePath!.path.split("/").last.toString();
          });
        } else {
          setState(() {
  ...
  Future<void> btnClick(BuildContext context, i1,mycureentReading) async {
    ...
    if (i1 == null) {
      ...
      if (code.toString().contains("200")) {
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GenerateBill()));
...
Future<String> attemptLogIn() async {
  ...
  var res = await http.post((Uri.parse(Apis.pay_bill)), body: {"schema":pref.getString(GlobalConstants.schema),
    ...
    "bill_fetch_ref":pref.getString(GlobalConstants.billFetchRef)},
      headers:{"Accept": "application/json", "Authorization": pref.getString(GlobalConstants.token)!} );
