List<PaymentHistoryModel> paymentHistoryListResponse(var json) {
  return List<PaymentHistoryModel>.from(json.map((x) => PaymentHistoryModel.fromJson(x)));
}
...
class PaymentHistoryModel {
  ...
  PaymentHistoryModel.fromJson(Map<String, dynamic> json) {
    ...
    invoiceDownload = json['invoice_download'] ??  "" ;
  }
