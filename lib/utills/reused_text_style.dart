...
class ReusedTextStyle {
  ...
  static const TextStyle menus = TextStyle(fontSize: 12, color: Colors.black87);
  static const TextStyle pngSERVICES = TextStyle(
      fontWeight: FontWeight.w300, fontSize: 16, color: Colors.black87);
  static const TextStyle bottomCaption = TextStyle(color: Colors.black);
  static const TextStyle number = TextStyle(color: Colors.grey);
  ...
  static const TextStyle inVoiceDOWNLOAD = TextStyle(
      ...
      fontWeight: FontWeight.bold);
  static const TextStyle currentMeeterReader =
